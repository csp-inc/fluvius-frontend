  ...
  return (
    <>
      ...
      >
        ...
        <Typography className={classes.graphTitle}>Concentração de Sedimentos em Suspensão na Estação {popupInfo.site_name}</Typography>
	    ...
	    data={data2}
          ...
          >
            ...
            <XAxis ticks={[1420156800000, 1451777744000, 1483400144000, 1514936144000, 1546472144000, 1578008144000, 1609630544000, 1641166544000]} dataKey="timestamp" domain={['auto', 'auto']} tickFormatter={(timestamp) => moment(timestamp).format('YYYY')} type='number' scale="time" >
              <Label value="Data" offset={-15} position="insideBottom" fill="#ffffff"/>
            </XAxis>
            <YAxis domain={[0, 200]}>
              <Label value="CSS (mg/L)" angle={-90} style={{ textAnchor: 'middle' }} position="insideLeft" fill="white"/>
            </YAxis> 
