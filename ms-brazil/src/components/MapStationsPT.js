  ...
  return (
    ...
    <Paper elevation={3} className={classes.box}>
      ...
      <FormControl color="primary" variant="filled" FormControlClasses={{ focused: classes.darkLabel }} className={classes.formControl}>
        <InputLabel style={{color: "black"}} htmlFor="outlined-age-native-simple">Selecione uma estação:</InputLabel>
            <Select
                id="selectBox"
                defaultValue={''}
                value={selectValue}
      ...
      <Paper className={classes.stationDetails} elevation={0}>
        <br></br>
          <Typography variant="body1">
              ...
              <hr></hr>
              Cidade Mais Próxima: &nbsp;&nbsp;&nbsp;<b>{popupInfo.nearest_city}</b>
              <hr></hr>
              Rio Mais Próximo: &nbsp;&nbsp;&nbsp;<b>{popupInfo.nearest_river}</b>
              <hr></hr>
              Dono da estação:  &nbsp;&nbsp;&nbsp;<b>{popupInfo.region}</b>
              <hr></hr>
          </Typography>
      </Paper>
