  ...
  return (
    <Box display="flex" flexWrap="wrap" flexDirection="row" justifyContent="center" alignItems="center" >
	  ...
	  Metodologia
        ...
        <Typography className={classes.text}>
          <p>Os dados de origem para este esforço de modelagem vieram de observações in situ (baseadas no solo) de CSS de rios e córregos no Brasil e nos Estados Unidos. Compilamos dados de ITV, <a className={classes.link} href="https://www.gov.br/ana/en">ANA</a> e <a className={classes.link} href="https://waterdata.usgs.gov/nwis/rt">USGS</a> e medidas de CSS convertidas para cada unidade de miligramas por litro (mg/L). Cada observação do CSS tem metadados e coordenadas associados que descrevem a hora e o local em que a medição foi feita. Usamos informações de geolocalização e carimbo de data/hora para associar cada observação a um <a className={classes.link} href="https://www.esa.int/Applications/Observing_the_Earth/Copernicus/Sentinel-2">Sentinel 2</a > imagem de satélite a ser usada para treinamento do modelo, em que as características espectrais dentro dos pixels de água no chip de imagem eram características no modelo e a medição CSS associada (transformada em log) é a resposta. Usamos dados da imagem Sentinel-2 L2A arquivada no <a className={classes.link} href="https://planetarycomputer.microsoft.com/dataset/sentinel-2-l2a#overview">Microsoft Planetary Computer< /a>.</p>
        </Typography>
        <Typography align="center" variant="h6">
          O Modelo
        </Typography>
